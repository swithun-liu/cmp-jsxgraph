...
| `src/parser/jessiecode.js` | generated jison-lex token rules, Jison-compatible source locations, and bounded tokenization; parser, AST, evaluator, scopes, and dependency discovery remain pending | `parser/JessieCodeLexer.kt` | Partially translated |
