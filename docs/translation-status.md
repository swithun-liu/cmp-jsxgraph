...
| `src/math/numerics.js` | linear algebra; Newton-Cotes, Romberg, Gauss-Legendre integration; numerical derivative; Newton, Brent, and Chandrupatla roots; domain search; Brent minimization | `math/Numerics.kt` | Partially translated |
