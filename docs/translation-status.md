...
| `src/base/point.js` | numeric free-point and JessieCode string-coordinate construction, board registration, coordinate update, bounds, `isOn` incidence checks for translated points, ordinary lines, and circle boundaries, plus native JessieCode creation from numeric or mixed numeric/string coordinates | `base/Point.kt`, `parser/NativeJessieCodeCreators.kt` | Translated dependency subset |
