...
| `src/math/geometry.js` | angles, distances, affine ratios, orientation, reflection, rotation, perpendicular and circumcenter constructions, polygon area/sorting/convexity and Graham-scan hulls, point-to-line/segment distance, and line/circle/segment intersections | `math/Geometry.kt` | Partially translated |
