...
object JsxGraphParityCorpus {
    ...
    val focusedCases: List<JsxGraphParityCase> = listOf(
        ...
        JsxGraphParityCase(
            id = "axis_2d",
            title = "2D axes",
            scenario = "Fixed, sticky, pixel-offset, fixed-tick, and automatic label placement branches share one source.",
            source = AXIS_2D_SOURCE,
            features = setOf(
                "jessiecode",
                "axis",
                "ticks",
        ...
        JsxGraphParityCase(
            id = "curve3d_projection",
            title = "Curve3D projection",
            scenario = "A parallel View3D projects component, vector, discrete, and transformed Curve3D definitions through ordinary Curve proxies.",
            source = CURVE_3D_PROJECTION_SOURCE,
            features = setOf(
                "jessiecode",
                "view3d",
                "curve3d",
        ...
        JsxGraphParityCase(
            id = "vectorfield3d_projection",
            title = "VectorField3D projection",
            scenario = "A parallel View3D projects component and array-returning VectorField3D definitions with viewport-sized arrowheads.",
            source = VECTOR_FIELD_3D_PROJECTION_SOURCE,
            features = setOf(
                "jessiecode",
                "view3d",
                "vectorfield3d",
        ...
        JsxGraphParityCase(
            id = "intersectioncircle3d_projection",
            title = "IntersectionCircle3D projection",
            scenario = "A parallel View3D projects Plane/Sphere and Sphere/Sphere intersection circles through owned dynamic centers and Curve3D proxies.",
            source = INTERSECTION_CIRCLE_3D_PROJECTION_SOURCE,
            features = setOf(
                "jessiecode",
                "view3d",
        ...
        JsxGraphParityCase(
            ...
            source = SURFACE_3D_PROJECTION_SOURCE,
            features = setOf(
                "jessiecode",
                "view3d",
                "surface3d",
...
private const val AXIS_2D_SOURCE: String = """
{
  "schemaVersion": 1,
  "inputKind": "jessiecode",
  "boardOptions": {
  ...
  "source": "use jxgbox;\nhorizontal = axis([-4, 0], [4, 0]) << id: \"horizontal\", name: \"\", position: \"fixed\", anchor: \"right\", anchorDist: \"24px\", ticksAutoPos: true, strokeColor: \"#49545D\", ticks: << id: \"horizontalTicks\", name: \"\", ticks: [-4, -2, 0, 2, 4], ticksDistance: undefined, minorTicks: 0, majorHeight: 16, drawZero: true, strokeColor: \"#246BCE\", strokeWidth: 2, label: << offset: [4, -14], fontSize: 12, strokeColor: \"#246BCE\" >> >> >>;\nvertical = axis([0, -4], [0, 4]) << id: \"vertical\", name: \"\", position: \"fixed\", anchor: \"right\", anchorDist: \"12%\", ticksAutoPos: true, strokeColor: \"#49545D\", ticks: << id: \"verticalTicks\", name: \"\", ticksDistance: 2, insertTicks: false, minorTicks: 0, majorHeight: 14, drawZero: true, strokeColor: \"#D55E00\", strokeWidth: 2, label: << anchorX: \"right\", offset: [8, 3], fontSize: 12, strokeColor: \"#D55E00\" >> >> >>;\nsticky = axis([-4, 7], [4, 7]) << id: \"sticky\", name: \"\", position: \"sticky\", anchor: \"left\", anchorDist: \"20px\", withTicks: false, strokeColor: \"#009E73\", strokeWidth: 3, ticks: << id: \"stickyTicks\", name: \"\" >> >>;"
}
"""
...
private const val CURVE_3D_PROJECTION_SOURCE: String = """
{
  "schemaVersion": 1,
  "inputKind": "jessiecode",
  "boardOptions": {
...
private const val VECTOR_FIELD_3D_PROJECTION_SOURCE: String = """
{
  "schemaVersion": 1,
  "inputKind": "jessiecode",
  "boardOptions": {
  ...
  "source": "use jxgbox;\nview = view3d(\n  [-5, -4],\n  [10, 8],\n  [[-5, 5], [-4, 4], [-3, 5]]\n) <<\n  id: \"view\", name: \"\", projection: \"parallel\",\n  axesPosition: \"none\",\n  xPlaneRear: << visible: false, type: \"wireframe\" >>,\n  yPlaneRear: << visible: false, type: \"wireframe\" >>,\n  zPlaneRear: << visible: false, type: \"wireframe\" >>,\n  depthOrder: << enabled: false >>,\n  az: << slider: << visible: false, start: 1 >> >>,\n  el: << slider: << visible: false, start: 0.3 >> >>,\n  bank: << slider: << visible: false, start: 0 >> >>\n>>;\nrotational = vectorfield3d(\n  view,\n  [\n    function(x, y, z) { return -0.32 * y; },\n    function(x, y, z) { return 0.32 * x; },\n    function(x, y, z) { return 0.16 * (1 - z); }\n  ],\n  [-3, 3, 3], [-2, 2, 2], [-2, 2, 2]\n) <<\n  id: \"rotational\", name: \"\", withLabel: false,\n  scale: 0.9,\n  arrowHead: << enabled: true, size: 6, angle: PI * 0.125 >>,\n  strokeColor: \"#0072B2\", strokeWidth: 2,\n  fixed: true, highlight: false\n>>;\nradial = vectorfield3d(\n  view,\n  function(x, y, z) { return [0.25 * x, 0.25 * y, -0.2 * z]; },\n  [-2, 2, 2], [-2, 2, 2], [2.5, 0, 2.5]\n) <<\n  id: \"radial\", name: \"\", withLabel: false,\n  scale: 0.8,\n  arrowHead: << enabled: false >>,\n  strokeColor: \"#D55E00\", strokeWidth: 3,\n  fixed: true, highlight: false\n>>;"
}
"""
...
private const val INTERSECTION_CIRCLE_3D_PROJECTION_SOURCE: String = """
{
  "schemaVersion": 1,
  "inputKind": "jessiecode",
  "boardOptions": {
...
private const val SURFACE_3D_PROJECTION_SOURCE: String = """
{
  "schemaVersion": 1,
  "inputKind": "jessiecode",
  "boardOptions": {
  ...
  "source": "use jxgbox;\nview = view3d(\n  [-5, -4],\n  [10, 8],\n  [[-5, 5], [-4, 4], [-3, 5]]\n) <<\n  id: \"view\", name: \"\", projection: \"parallel\",\n  axesPosition: \"none\",\n  xPlaneRear: << visible: false, type: \"wireframe\" >>,\n  yPlaneRear: << visible: false, type: \"wireframe\" >>,\n  zPlaneRear: << visible: false, type: \"wireframe\" >>,\n  depthOrder: << enabled: true >>,\n  az: << slider: << visible: false, start: 1 >> >>,\n  el: << slider: << visible: false, start: 0.3 >> >>,\n  bank: << slider: << visible: false, start: 0 >> >>\n>>;\nwire = functiongraph3d(\n  view,\n  function(x, y) { return 0.7 * sin(1.5 * x) * cos(y) - 1.4; },\n  [-3.4, -0.4], [-2.4, 2.4]\n) <<\n  id: \"wire\", name: \"\", withLabel: false,\n  stepsU: 9, stepsV: 8,\n  strokeColor: \"#0072B2\", strokeWidth: 2,\n  fixed: true, highlight: false\n>>;\nfilled = parametricsurface3d(\n  view,\n  function(u, v) { return 0.6 + 1.6 * u; },\n  function(u, v) { return 1.8 * v; },\n  function(u, v) { return 0.7 * cos(PI * u) * cos(PI * v) + 0.8; },\n  [0, 1.8], [-1, 1]\n) <<\n  id: \"filled\", name: \"\", withLabel: false,\n  type: \"shader\", tiling: \"triangle\",\n  stepsU: 7, stepsV: 6,\n  fixed: true, highlight: false,\n  polyhedron: <<\n    strokeColor: \"#333333\", strokeWidth: 0.4,\n    fillColorArray: [\"#E69F00\", \"#F0E442\"], fillOpacity: 0.86,\n    shader: <<\n      hue: 35, saturation: 80,\n      minLightness: 45, maxLightness: 82\n    >>\n  >>\n>>;"
}
"""
