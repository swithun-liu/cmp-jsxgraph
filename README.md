...
to browse 86 source-controlled cases: 30 independent production scenarios and
56 focused regression fixtures. Use the case picker or previous/next controls,
...
- JessieCode lexical analysis, the first statement/expression AST/parser
  ...
  `src/3d/box3d.js`, `src/3d/curve3d.js`, `src/3d/polygon3d.js`, `src/3d/face3d.js`,
  ...
  creation, Curve3D component/vector/discrete/transformed forms and ordinary
  Curve proxy rendering, Polygon3D proxy rendering and nested vertex/border styles,
...
animations, Stable qualification, Curve3D parametric projection pending the
source-mapped COBYLA dependency, the `circle3d`, `surface3d`, and `sphere3d`
modules, or the complete 3D APIs.
